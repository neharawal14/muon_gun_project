...
config.General.workArea = 'crab_projects_pt50_2ndfull_1st_large_step2'
config.General.transferOutputs = True
config.General.failureLimit=1
config.General.transferLogs=True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'SingleMuPt50_2ndfull_GEN_DIGI_L1_PU_RAW2DIGI_L1Reco_RECO.py'
...
config.Data.inputDataset = '/SingleMuPt50_2ndfull_1st_large_GEN-SIM_step1_neha/nrawal-crab_SingleMuPt50_2ndfull_1st_large_step2-e7fd515534390693da605b5c2a01534c/USER'
