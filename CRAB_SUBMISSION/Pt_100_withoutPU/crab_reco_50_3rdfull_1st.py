...
config.General.workArea = 'crab_projects_pt50_3rdfull_1st'
config.General.transferOutputs = True
config.General.failureLimit=1
config.General.transferLogs=True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'SingleMuPt50_3rdfull_1st_GEN_DIGI_L1_RAW2DIGI_RECO.py'
...
config.Data.inputDataset = '/SingleMuPt50_3rdfull_1st_large_GEN-SIM_step1_neha/nrawal-crab_SingleMuPt50_3rdfull_1st_large_step2-b92895268740895c325a8071b664b5b5/USER'
